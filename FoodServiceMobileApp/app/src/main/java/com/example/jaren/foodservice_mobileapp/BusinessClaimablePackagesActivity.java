...
public class BusinessClaimablePackagesActivity extends AppCompatActivity {
    ...
    private String urlMarkReceived = "http://10.0.2.2:50577/api/package/markreceived";
    private String urlDeletePackage = "http://10.0.2.2:50577/api/package/deletepackage";
    ...
    class Package {
        ...
        public Package(JSONObject jsonPkg) {
            try {
                ...
                quantity = jsonPkg.getString("quantity");
                received = false;
                deleted = false;
    ...
    class CustomAdapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            TextView LVQty = (TextView)view.findViewById(R.id.tvLVQty);

            String qty = "QTY: " + pkg.quantity;
            LVQty.setText(qty);
